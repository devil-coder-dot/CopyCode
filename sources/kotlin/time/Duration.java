...
public final class Duration implements Comparable<Duration> {
    ...
    public static String m966toStringimpl(double d) {
        ...
        if (r0 < 1.0E-6d) {
            ...
            double r2 = m960toDoubleimpl(d, timeUnit);
            ...
            if (!z) {
                ...
                str = FormatToDecimalsKt.formatToExactDecimals(r2, m953precisionimpl(d, Math.abs(r2)));
            }
            sb.append(str);
        ...
        i = 0;
        z = true;
        double r22 = m960toDoubleimpl(d, timeUnit);
