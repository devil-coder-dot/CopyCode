...
public final class Cookie {
    ...
    public static final class Companion {
        ...
        public final Cookie parse$okhttp(long j, HttpUrl httpUrl, String str) {
            ...
            String str5 = str;
            Intrinsics.checkParameterIsNotNull(httpUrl, ImagesContract.URL);
            Intrinsics.checkParameterIsNotNull(str5, "setCookie");
            String str6 = str;
            int delimiterOffset$default = Util.delimiterOffset$default(str6, ';', 0, 0, 6, (Object) null);
            int delimiterOffset$default2 = Util.delimiterOffset$default(str6, '=', 0, delimiterOffset$default, 2, (Object) null);
            if (delimiterOffset$default2 == delimiterOffset$default) {
                return null;
            }
            String trimSubstring$default = Util.trimSubstring$default(str5, 0, delimiterOffset$default2, 1, null);
            if ((trimSubstring$default.length() == 0) || Util.indexOfControlOrNonAscii(trimSubstring$default) != -1) {
                return null;
            }
            String trimSubstring = Util.trimSubstring(str5, delimiterOffset$default2 + 1, delimiterOffset$default);
            ...
            while (i < length) {
                int delimiterOffset = Util.delimiterOffset(str5, ';', i, length);
                int delimiterOffset2 = Util.delimiterOffset(str5, '=', i, delimiterOffset);
                String trimSubstring2 = Util.trimSubstring(str5, i, delimiterOffset2);
                String trimSubstring3 = delimiterOffset2 < delimiterOffset ? Util.trimSubstring(str5, delimiterOffset2 + 1, delimiterOffset) : "";
                if (StringsKt.equals(trimSubstring2, "expires", true)) {
                    ...
                    if (StringsKt.equals(trimSubstring2, "domain", true)) {
                        str7 = parseDomain(trimSubstring3);
                        z4 = false;
            ...
            if (j3 != Long.MIN_VALUE) {
                ...
                str3 = "/";
                if (str8 != null || !StringsKt.startsWith$default(str8, str3, false, 2, cookie)) {
                    String encodedPath = httpUrl.encodedPath();
                ...
                Cookie cookie2 = new Cookie(trimSubstring$default, trimSubstring, j2, str2, str4, z, z2, z3, z4, null);
                return cookie2;
            }
            j2 = j5;
            host = httpUrl.host();
            ...
            str4 = str3;
            Cookie cookie22 = new Cookie(trimSubstring$default, trimSubstring, j2, str2, str4, z, z2, z3, z4, null);
            return cookie22;
        }
    ...
    public final String m1012deprecated_name() {
        return this.name;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "value", imports = {}))
    /* renamed from: -deprecated_value reason: not valid java name */
    public final String m1016deprecated_value() {
        return this.value;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "persistent", imports = {}))
    /* renamed from: -deprecated_persistent reason: not valid java name */
    public final boolean m1014deprecated_persistent() {
        return this.persistent;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "expiresAt", imports = {}))
    /* renamed from: -deprecated_expiresAt reason: not valid java name */
    public final long m1009deprecated_expiresAt() {
        return this.expiresAt;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "hostOnly", imports = {}))
    /* renamed from: -deprecated_hostOnly reason: not valid java name */
    public final boolean m1010deprecated_hostOnly() {
        return this.hostOnly;
    }
    ...
    public final String m1008deprecated_domain() {
        return this.domain;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "path", imports = {}))
    /* renamed from: -deprecated_path reason: not valid java name */
    public final String m1013deprecated_path() {
        return this.path;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "httpOnly", imports = {}))
    /* renamed from: -deprecated_httpOnly reason: not valid java name */
    public final boolean m1011deprecated_httpOnly() {
        return this.httpOnly;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "secure", imports = {}))
    /* renamed from: -deprecated_secure reason: not valid java name */
    public final boolean m1015deprecated_secure() {
        return this.secure;
    }
