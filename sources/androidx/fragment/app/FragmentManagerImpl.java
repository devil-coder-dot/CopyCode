...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
  ...
  mth insns count: 510
    ...
    public void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        ...
        if (fragment2.mMaxState == State.CREATED) {
            i5 = Math.min(i4, 1);
        } else {
            i5 = Math.min(i4, fragment2.mMaxState.ordinal());
        }
        ? r11 = i5;
        ...
        if (i6 <= r11) {
            if (!fragment2.mFromLayout || fragment2.mInLayout) {
                ...
                if (i7 != 0) {
                        ...
                        if (!fragment2.mFromLayout) {
                            if (fragment2.mContainerId != 0) {
                                ...
                                if (viewGroup == null && !fragment2.mRestored) {
                                    ...
                                    sb4.append("No view found for id 0x");
                                    sb4.append(Integer.toHexString(fragment2.mContainerId));
                                    sb4.append(" (");
                                    sb4.append(str);
                    ...
                    if (r11 > 0) {
                        ...
                        if (fragment2.mTargetWho != null) {
                            Fragment fragment5 = (Fragment) this.mActive.get(fragment2.mTargetWho);
                            if (fragment5 == null) {
            ...
            if (r11 < 1) {
                ...
                if (fragment.getAnimatingAway() == null && fragment.getAnimator() == null) {
                    ...
                    boolean z2 = fragment2.mRemoving && !fragment.isInBackStack();
                    if (z2 || this.mNonConfig.shouldDestroy(fragment2)) {
                        FragmentHostCallback fragmentHostCallback = this.mHost;
                        if (fragmentHostCallback instanceof ViewModelStoreOwner) {
                            r82 = this.mNonConfig.isCleared();
                        } else if (fragmentHostCallback.getContext() instanceof Activity) {
                            r82 = true ^ ((Activity) this.mHost.getContext()).isChangingConfigurations();
                        }
                        if (z2 || r82 != 0) {
                    ...
                    if (!z) {
                        if (z2 || this.mNonConfig.shouldDestroy(fragment2)) {
                            ...
                            if (fragment2.mTargetWho != null) {
                                Fragment fragment6 = (Fragment) this.mActive.get(fragment2.mTargetWho);
                                if (fragment6 != null && fragment6.getRetainInstance()) {
                                    fragment2.mTarget = fragment6;
                                }
                            }
                        }
                    }
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (fragment == null) {
            fragment = getFragmentFactory().instantiate(context.getClassLoader(), str3);
