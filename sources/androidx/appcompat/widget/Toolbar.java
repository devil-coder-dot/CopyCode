...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            if (!shouldLayout || shouldLayout2) {
                ...
                if (!z2) {
                    ...
                    if (shouldLayout) {
                        ...
                        i17 = measuredHeight + layoutParams5.bottomMargin;
                    } else {
                        i21 = min2;
                    }
                    if (shouldLayout2) {
                        LayoutParams layoutParams6 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                        int i27 = i17 + layoutParams6.topMargin;
                    ...
                    if (shouldLayout) {
                        ...
                        i17 = measuredHeight2 + layoutParams7.bottomMargin;
                    } else {
                        i19 = max;
                    }
                    if (shouldLayout2) {
                        LayoutParams layoutParams8 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                        int i30 = i17 + layoutParams8.topMargin;
                    ...
                    for (i13 = 0; i13 < size; i13++) {
                        max = layoutChildLeft((View) this.mTempViews.get(i13), max, iArr, i10);
                    }
                    int i32 = i10;
                    addCustomViewsWithGravity(this.mTempViews, 5);
                    size2 = this.mTempViews.size();
                    for (i14 = 0; i14 < size2; i14++) {
                        min2 = layoutChildRight((View) this.mTempViews.get(i14), min2, iArr, i32);
                    }
                    addCustomViewsWithGravity(this.mTempViews, 1);
                    int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
                    i15 = (i11 + (((i9 - i11) - i7) / 2)) - (viewListMeasuredWidth / 2);
                    int i33 = viewListMeasuredWidth + i15;
                    if (i15 >= max) {
                        max = i33 > min2 ? i15 - (i33 - min2) : i15;
                    }
                    size3 = this.mTempViews.size();
                    while (i12 < size3) {
                        max = layoutChildLeft((View) this.mTempViews.get(i12), max, iArr, i32);
                        i12++;
                    }
            ...
            int i332 = viewListMeasuredWidth2 + i15;
            if (i15 >= max) {
            }
            size3 = this.mTempViews.size();
            while (i12 < size3) {
