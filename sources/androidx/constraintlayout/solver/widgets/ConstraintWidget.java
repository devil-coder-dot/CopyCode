...
public class ConstraintWidget {
    ...
    private void applyConstraints(LinearSystem linearSystem, boolean z, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z2, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z3, boolean z4, int i5, int i6, int i7, float f2, boolean z5) {
        ...
        boolean z17 = (i25 == 1 || i25 == 2 || i25 == 3 || i25 != 4 || i24 == 4) ? false : true;
        if (this.mVisibility == 8) {
            i8 = 0;
            z6 = false;
        } else {
                ...
                if (z6) {
                    if (z2) {
                        ...
                        if (i21 < Integer.MAX_VALUE) {
                            linearSystem2.addLowerThan(createObjectVariable2, createObjectVariable, i21, 6);
                        }
                    } else {
                        ...
                        if (!isConnected && isConnected2) {
                            ...
                            if (z7) {
                                ...
                                if (i10 == 0) {
                                    ...
                                    linearSystem2.addEquality(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), i18);
                                    linearSystem2.addEquality(createObjectVariable2, solverVariable6, -constraintAnchor2.getMargin(), i18);
                                    z9 = i12 > 0 || i11 > 0;
                                    z8 = z14;
                                    i15 = 5;
                                } else {
                                    ...
                                    if (i27 == 1) {
                                        ...
                                        if (i27 == 3) {
                                            int i28 = (z3 || this.mResolvedDimensionRatioSide == -1 || i12 > 0) ? 4 : 6;
                                            linearSystem2.addEquality(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), i28);
                                            linearSystem2.addEquality(createObjectVariable2, solverVariable6, -constraintAnchor2.getMargin(), i28);
                                            z12 = true;
                                            z13 = true;
                                            i15 = 5;
                                            if (z9) {
                                                ...
                                                boolean z18 = constraintAnchor.mTarget.mOwner instanceof Barrier;
                                                boolean z19 = constraintAnchor2.mTarget.mOwner instanceof Barrier;
                                                if (z18 && !z19) {
                                                    z11 = z;
                                                    i17 = 6;
                                                    i16 = 5;
                                                    ...
                                                    linearSystem2.addGreaterThan(createObjectVariable, solverVariable9, constraintAnchor.getMargin(), i16);
                                                    linearSystem2.addLowerThan(solverVariable5, solverVariable8, -constraintAnchor2.getMargin(), i17);
                                                    i14 = 0;
                                                    if (z) {
                                                    }
                                                    if (z) {
                                                    ...
                                                    if (z) {
                                                        linearSystem2.addGreaterThan(solverVariable2, solverVariable5, i14, 6);
                                                    }
                                                    return;
                                                }
                                            } else {
