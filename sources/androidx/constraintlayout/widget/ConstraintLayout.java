...
public class ConstraintLayout extends ViewGroup {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (!layoutParams.isGuideline && !layoutParams.isHelper) {
                    ...
                    if (i12 == 0 || i13 == 0) {
                        ...
                        boolean z3 = i12 == -2 ? USE_CONSTRAINTS_HELPER : false;
                        ...
                        constraintWidget.setWidthWrapContent(i12 == -2 ? USE_CONSTRAINTS_HELPER : false);
                        constraintWidget.setHeightWrapContent(i13 == -2 ? USE_CONSTRAINTS_HELPER : false);
            ...
            if (childAt2.getVisibility() != i3) {
                ...
                if (!layoutParams2.isGuideline && !layoutParams2.isHelper) {
                    ...
                    if (i16 == 0 || i17 == 0) {
                        ...
                        boolean z5 = (constraintWidget2.getAnchor(Type.LEFT).getTarget() == null || constraintWidget2.getAnchor(Type.RIGHT).getTarget() == null) ? false : USE_CONSTRAINTS_HELPER;
                        ...
                        i5 = childCount;
                        boolean z6 = (constraintWidget2.getAnchor(Type.TOP).getTarget() == null || constraintWidget2.getAnchor(Type.BOTTOM).getTarget() == null) ? false : USE_CONSTRAINTS_HELPER;
                        if (i16 != 0 || i17 != 0 || !z5 || !z6) {
                            i4 = i15;
                            LayoutParams layoutParams3 = layoutParams2;
                            boolean z7 = constraintLayout2.mLayoutWidget.getHorizontalDimensionBehaviour() != DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                            boolean z8 = constraintLayout2.mLayoutWidget.getVerticalDimensionBehaviour() != DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                            if (!z7) {
                                ...
                                if (!z7 || !constraintWidget2.isSpreadWidth() || !z5 || !resolutionNode.isResolved() || !resolutionNode2.isResolved()) {
                                    ...
                                    if (i17 != 0) {
                                        ...
                                        if (i17 == -1) {
                                            ...
                                            z2 = i17 == -2 ? USE_CONSTRAINTS_HELPER : false;
                                            ...
                                            constraintWidget2.setWidthWrapContent(i16 == -2 ? USE_CONSTRAINTS_HELPER : false);
                                            constraintWidget2.setHeightWrapContent(i17 == -2 ? USE_CONSTRAINTS_HELPER : false);
    ...
    public void onMeasure(int i, int i2) {
        ...
        boolean z6 = (this.mOptimizationLevel & 8) == 8 ? USE_CONSTRAINTS_HELPER : false;
        if (z6) {
        ...
        if ((this.mOptimizationLevel & 32) == 32) {
            ...
            if (this.mLayoutWidget.mVerticalWrapOptimized && this.mLayoutWidget.mWrapFixedHeight > size3) {
                ...
                if (size <= 0) {
                    boolean z7 = this.mLayoutWidget.getHorizontalDimensionBehaviour() == DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                    boolean z8 = this.mLayoutWidget.getVerticalDimensionBehaviour() == DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                            ...
                            if (!layoutParams.isHelper && !layoutParams.isGuideline) {
                                ...
                                if (view.getVisibility() != 8 && (!z6 || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved())) {
                                    if (layoutParams.width != -2 || !layoutParams.horizontalDimensionFixed) {
                                        i8 = MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), 1073741824);
                                    } else {
                                        i8 = getChildMeasureSpec(i11, paddingRight, layoutParams.width);
                                    }
                                    if (layoutParams.height != -2 || !layoutParams.verticalDimensionFixed) {
                                        i9 = MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), 1073741824);
                                    } else {
