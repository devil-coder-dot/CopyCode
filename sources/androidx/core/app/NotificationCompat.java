  ...
  mth insns count: 64
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            if (stringArray != null && stringArray.length == 1) {
                if (remoteInput != null) {
                    ? remoteInput2 = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), VERSION.SDK_INT >= 29 ? remoteInput.getEditChoicesBeforeSending() : 0, remoteInput.getExtras(), null);
                    r1 = remoteInput2;
                }
                ...
                if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    ...
                    if (this.mBuilder.mContentText == null) {
                        ...
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            ...
                            if (this.mBuilder.mChronometerCountDown && VERSION.SDK_INT >= 24) {
