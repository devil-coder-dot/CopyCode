                ...
                for (Entry entry : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        if (value != null) {
                            ...
                            sb.append(str);
                            sb.append("\"");
                            requestBuilder.addPart(okhttp3.Headers.of("Content-Disposition", sb.toString(), "Content-Transfer-Encoding", this.transferEncoding), (RequestBody) this.valueConverter.convert(value));
                        } else {
                            Method method2 = this.method;
                            int i = this.p;
                            StringBuilder sb2 = new StringBuilder();
