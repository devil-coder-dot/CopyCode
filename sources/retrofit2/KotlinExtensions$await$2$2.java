    ...
    public void onResponse(Call<T> call, Response<T> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (body == null) {
                ...
                continuation.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                return;
            }
            Continuation continuation2 = this.$continuation;
            Companion companion2 = Result.Companion;
            continuation2.resumeWith(Result.m3constructorimpl(body));
            return;
        }
        ...
        continuation3.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(httpException)));
    }
